...
const mockImpl=()=>{}
const selectedLoc=  Array({ name:"Lavender Haze",description:"I love this flower field",locOwner:'Batu',category:'park',privacy:'private',key:'283987r',comments:[{comment:'First comment',commentPic:'pic.png',ratingStars:'3'},{comment:'Second comment',commentPic:'pic.png',ratingStars:'3'}]});
describe("Container renders properly",()=>{

    beforeEach(()=>
        render(<InfoList isInfoVisible={mockImpl()} onInfoList={mockImpl()} selected={selectedLoc} newComments={mockImpl()}  onEditMarker={mockImpl()}  profilename={"Batu"} />)
    )
...
describe('Detailed location view: Location description',()=>{
    ...
    beforeEach(()=> {
        render(<InfoList isInfoVisible={true} onInfoList={true} selected={selectedLoc} newComments={mockImpl()}
                         onEditMarker={mockImpl()} profilename={"Batu"}/>)
