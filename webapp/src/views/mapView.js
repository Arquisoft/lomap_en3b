  ...
  return (
      <>
        ...
        <Grid item xs={12} md={8}>
          <Map filterChanges={changesInFilters} selectedFilters={selectedFilters} isInteractive={isInteractive} session={session} onMarkerAdded={handleMarkerAdded} crl={crl}/>
