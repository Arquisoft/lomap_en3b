...
The deployment url is: [https://arquisoft.github.io/lomap_en3b/](https://arquisoft.github.io/lomap_en3b/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/lomap_en3b/](https://arquisoft.github.io/lomap_en3b/) we need to execute `npm run deploy`.
